      ...
      cell: ({ row }) => {
        if (
              ...
              <TooltipProvider delayDuration={0} skipDelayDuration={1000}>
                <Tooltip>
                  ...
                  <TooltipContent className="bg-transparent border-none shadow-none">
                    <p
                      className={
                        "w-fit text-xs flex place-items-center gap-1 truncate text-black bg-darkGray pl-2 pr-1 py-1 rounded-3xl font-semibold"
                      }
                    >
                      Parts
                      <span className="rounded-full bg-white text-black p-1 px-3 text-center flex justify-center place-items-center line-clamp-none">
          ...
          return (
            <p
              className={
                "w-fit text-xs flex place-items-center gap-1 truncate text-black bg-black px-2 py-1 rounded-3xl font-semibold"
              }
            >
              None
            </p>
